<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            class="mt-1 block w-full" :value="old('username', $user->username)" 
        ...
        <div>
            ...
            <x-input-textarea id="bio" name="bio" class="mt-1 block w-full" rows="3">{{ old('bio', $user->bio) }}</x-input-textarea>
